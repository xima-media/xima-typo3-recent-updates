...
namespace Xima\XimaRecentUpdatesWidget\Widgets;
...
class RecentUpdates implements WidgetInterface
{
    ...
    {
        $template = GeneralUtility::getFileAbsFileName('EXT:xima_recent_updates_widget/Resources/Private/Templates/List.html');
